package com.example.qsys.yousi.common.widget.emptyview;
...
/**
 * Created by hanshaokai on 2017/10/23 14:17
 */
...
public class EmptyLayoutView extends LinearLayout {
    ...
    private int mErrorDrawable = R.mipmap.error_show;
    private int mEmptyDrawable = R.drawable.no_content_tip;
    private int mLoadingDrawable = R.drawable.loading_progress;

    private String mErrorMessage = "发生了一些错误";
    private String mEmptyMessage = "啥也没有";
    private String mLoadingMessage = "请等一等";
    ...
    public EmptyLayoutView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            setTopDrawables(mLoadingMessageView,mLoadingDrawable);// loading 不能已经有loading image view ，不能直接设置TopDrawable
    ...
    private void setDefaultValues() {
        if (mEmptyView == null) {
            mEmptyView = (ViewGroup) mInflater.inflate(R.layout.yousi_common_empty_view, null);
        ...
        if (mLoadingView == null) {
            mLoadingView = (ViewGroup) mInflater.inflate(R.layout.yousi_common_loading_view, null);
        ...
        if (mErrorView == null) {
            mErrorView = (ViewGroup) mInflater.inflate(R.layout.yousi_common_error_view, null);
